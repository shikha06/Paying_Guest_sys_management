...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home3.php" ><img src="image/logo1.jpg" style="height: 60px; width: 60px; border-radius: 50%;" title="home"></a>
    </div>
...
<div class="jumbotron text-center">
  ...
  <?php if($r ==1 ){
          echo "<h4 style='text-transform:uppercase;text-shadow:2px 1px red; letter-spacing: 2px;'>WELCOME!! DEAR "."<i><a href='user1.php'>".$_SESSION["email"]."</a></i>"." TO PGMS</h4>";}
         ?>
</div>
...
<div id="about" class="container-fluid" >
  <div class="row">
    <div class="col-sm-8">
      ...
      <br><a href = "user1.php"><button class="btn btn-default btn-lg">Get in Touch</button></a>
    </div>
    <div class="col-sm-4">
...
<div id="help" class="container-fluid" style="background-color: black; opacity: 0.8; color: white;  margin-top: -27px;" >
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span> +91 8360256637</p>
...
<img src="image/map1.jpg" class="w3-image w3-greyscale-min" style="width:100%; height: -20%;">
